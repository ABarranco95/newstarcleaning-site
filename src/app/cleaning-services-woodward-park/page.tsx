...
export const metadata: Metadata = {
  ...
  description:
    "Reliable house cleaning for Woodward Park families. Recurring, deep, and move-in/move-out cleaning from vetted, insured cleaners. Book in 60 seconds.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Trusted Woodward Park house cleaning. Background-checked, insured. Book online in 60 seconds.",
