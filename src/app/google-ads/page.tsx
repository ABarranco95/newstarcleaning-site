...
export const metadata: Metadata = {
  ...
  description: "Professional house cleaning in Fresno. 5.0★ Google rating, background-checked cleaners, 100% satisfaction guarantee. Request a fast quote online!",
  robots: {
    index: false,
    follow: false,
  },
