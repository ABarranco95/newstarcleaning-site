...
// Stroke icon set. Paths adapted from Feather Icons (MIT, feathericons.com).
// Decorative by default: every call site carries its own visible text.
const paths = {
  ...
  supplies: <><path d="M9 3h6v4H9z" /><path d="M8 7h8l1 4v9a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-9z" /><path d="M10 14h4" /></>,
} as const;

export type IconName = keyof typeof paths;

export default function Icon({ name, className = "ns-icon", ...rest }: { name: IconName } & SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function StarRow({ className = "ns-stars" }: { className?: string }) {
  return (
