    ...
    >
      <div className="mx-auto flex max-w-lg items-stretch gap-2 px-3 py-2.5">
        <a
          ...
          className="flex flex-1 items-center justify-center gap-1.5 rounded-full border border-line bg-white px-3 py-3 text-xs font-semibold text-primary"
        ...
        <a
          href="#quote"
          className="flex flex-1 items-center justify-center rounded-full bg-primary px-3 py-3 text-xs font-semibold text-white"
        >
          Quote
        </a>
        <Link
          href="/book-now"
          className="flex flex-[1.4] items-center justify-center gap-1.5 rounded-full bg-accent px-3 py-3 text-xs font-semibold text-white shadow-[0_8px_24px_-12px_rgba(239,106,55,0.6)]"
        >
          Book now
          <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
